...
$(document).ready(function () {
  $("#testimonial-sliderpub1").owlCarousel({
    items: 3,
    loop: true,
    autoplay: true,
    responsive: {
      ...
      600: {
        items: 1 // Show two items on screens 600px and larger
      },
      1000: {
...
$(document).ready(function () {
  $("#testimonial-slider5").owlCarousel({
    items: 2, // Display two items
    autoplay: true,
    center: true,
    autoplayTimeout: 3000, // Adjust timeout as needed
    loop: true,
    nav: false,
...
$(document).ready(function () {
  $("#testimonial-slider7").owlCarousel({
    ...
    margin: 10,
    nav: true,
    navText: ['<i class="fa-solid fa-left-long rot"></i>', '<i class="fa-solid fa-right-long rot"></i>'],
    dots: false,
...
$(document).ready(function () {
  $("#testimonial-slider5").owlCarousel({
    ...
    responsive: {
      ...
      1000: {
        items: 2 // Show three items on screens 1000px and larger
      }
    }
  });
});
...
(function () {
  ...
  var carousels = function () {
    console.log("Initializing Owl Carousel");  // Add this line
...
function myFunc() {
  ...
  Calendar.prototype.openDay = function (el) {
    ...
    if (currentOpened) {
      ...
      currentOpened.className = "caldetailsout";
    }

    //Create the caldetailsContainer
    caldetails = createElement("div", "caldetailsin");
  ...
  Calendar.prototype.renderEvents = function (events, ele) {
    //Remove any events in the current caldetailselement
